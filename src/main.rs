                ...
                match response_type {
                    ...
                    xcb::KEY_PRESS => {
                        ...
                        match event.detail() {
                            54 => {
                                println!("c pressed");
                                let active_window = ewmh::get_active_window(&conn, screen_num)
                                    .get_reply()
                                    .map_err(|e| e)
                                    .ok();
                                ...
                                if let Some(active_window) = active_window {
                                    ...
                                    xcb::unmap_window(&conn, active_window);
                                    xcb::destroy_window(&conn, active_window);
                                } else {
                    ...
                    xcb::CONFIGURE_REQUEST => {
                        ...
                        ewmh::set_active_window(&conn, screen_num, event.window());
